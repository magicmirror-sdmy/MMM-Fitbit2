...
Module.register("MMM-Fitbit2", {
    ...
    socketNotificationReceived: function(notification, payload) {
        if (notification === "API_DATA_RECEIVED") {
            ...
            // Broadcast the updated data globally using FITBIT_DATA
            this.sendNotification("FITBIT_DATA", this.userData);
        }
    
        if (notification === "GET_TODO") {
            // Reuse the existing "GET DATA" functionality
            this.getData("Triggered by GET_TODO");
        }
